        ...
        <>
          {visibleMatches.length > 0 ? (
            visibleMatches.map((match) => (
              <div
                key={match.gameId}
                className="border-darkgrey border-2 m-auto rounded-lg w-4/5 lg:w-2/5 bg-brandy shadow-md hover:bg-sandybrown transition duration-300 dark:bg-mineshaft dark:hover:bg-gray-700"
              >
